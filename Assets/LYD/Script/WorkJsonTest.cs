...
public class idLists
{
    ...
    public List<CardLists> inlineCards = new List<CardLists>();
}
**//*//*
[System.Serializable]
public class ArrayData1
{
    public List<idLists> data1;
}*/
...
public class WorkJsonTest : MonoBehaviour
{
    ...
    public MyTask taskInfo = new MyTask();
   // public idLists idListinfo = new idLists();
   // public CardLists cardListinfo;


   // public List<MyTask> dataList = new List<MyTask>();
   // public List<idLists> dataList1 = new List<idLists>();
